...
class IndexSourceLink final {
 public:
  ...
  constexpr IndexSourceLink(Acts::GeometryIdentifier gid, ActsExamples::Index idx)
...
/// Filter
struct IndexSourceLinkAccessor : ActsExamples::GeometryIdMultisetAccessor<IndexSourceLink> {
  using BaseIterator = ActsExamples::GeometryIdMultisetAccessor<IndexSourceLink>::Iterator;

...
PHLEX_REGISTER_PROVIDERS(m, config) {
    ...
    provide_hit_type<SHiP::StrawTubesHit>(m, input_file, "straw_tubes_hits", "straw_tubes_hits",
                                          layer);
    provide_hit_type<SHiP::CaloHit>(m, input_file, "calorimeter_hits", "calorimeter_hits", layer);
